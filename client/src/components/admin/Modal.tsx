...
function Modal({ title, isOpen, onClose, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
      ...
      <section className="relative z-10 flex h-full max-h-full w-full flex-col overflow-hidden border-t-[3px] border-[#C9A84C] bg-white text-[#111827] shadow-2xl shadow-black/20 sm:h-auto sm:max-h-[calc(100vh-2rem)] sm:max-w-4xl sm:rounded-2xl">
        <div className="flex shrink-0 items-center justify-between gap-4 border-b border-[#F0EDE8] px-5 py-4">
